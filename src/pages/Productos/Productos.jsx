...
export default function Productos() {
  ...
  return (<>
    ...
    <div className='mc-containerTitulosProductos'>
        <h2 className='mc-TituloProductos'>Nuestra Tienda</h2>
    </div>
    <div className='mc-containerProductos' id="productos">
        <div className='mc-ContainerFiltros'>
            ...
            <div className='mc-containerPrecios'>
                <TextField id="outlined-basic" label="$ Minimo" sx={{ width: 120 }} variant="outlined" />
                <h4 className='mc-guionPrecio'>-</h4>
                <TextField id="outlined-basic" label="$ Maximo" sx={{ width: 120 }} variant="outlined" />
            </div>
